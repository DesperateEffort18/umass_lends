...
4. Items with 2+ reports for the same reason will be automatically marked as unavailable
...
### Features
- **Auto-removal**: When an item receives 2+ reports for the same reason, it's automatically marked as unavailable
